// =====================================================
//  TW SCAVENGER SAFE CORE + PANEL v3.2
...
(function () {
    ...
    console.log("Scavenger Safe Core + Panel v3.2 başlatılıyor...");
    ...
    try {
        ...
        s.onload = function () {
            ...
            if (isScavengeScreen()) {
                ...
                console.log("Temizleme paneli sadece temizleme ekranında görünür.");
            }
        };
        s.onerror = function () {
    ...
    function createScavengerPanel() {
        try {
            if (!isScavengeScreen()) {
                console.log("Panel: Temizleme ekranında değiliz, panel oluşturulmadı.");
                return;
            }
            if (document.getElementById("tw-scav-panel")) {
                console.log("Panel zaten var, yeniden oluşturulmadı.");
                return;
            }
            ...
            function unitIcon(u) {
                ...
                return (
                    ...
                    'width:18px;height:18px;border-radius:4px;background:#262626;margin-right:3px;">' +
                    '<img src="' +
                    imgBase +
                    "unit/unit_" +
                    u +
            ...
            function unitRow(unit, label) {
                return (
                    ...
                    '<input type="checkbox" checked data-unit="' +
                    unit +
                    '" style="margin:0;">' +
                    unitIcon(unit) +
                    "<span>" +
            ...
            html += unitRow("spear", "Mızrakçı");
            html += unitRow("sword", "Kılıç");
            html += unitRow("axe", "Balta");
            html += unitRow("archer", "Okçu");
            html += unitRow("light", "Hafif Atlı");
            html += unitRow("marcher", "Atlı Okçu");
            html += unitRow("heavy", "Ağır Atlı");
            html += unitRow("knight", "Şövalye");
                ...
                openPrefsBtn.addEventListener("click", function () {
                    try {
                        ...
                        links.forEach(function (a) {
                            ...
                            if (
                                txt.indexOf("preferences") !== -1 ||
                                txt.indexOf("tercihler") !== -1
                            ) {
                                a.click();
                                found = true;
                            }
                        ...
                        if (!found) {
                            alert(
                                "TwCheese tercih bağlantısı bulunamadı.\nYine de ASS paneli aktif olmalı."
                            );
                        }
                    } catch (e) {
            ...
            console.log("Temizleme Paneli oluşturuldu.");
        } catch (e) {
